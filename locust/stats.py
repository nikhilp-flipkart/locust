...
class StatsEntry(object):
    ...
    def percentile(self, tpl=" %-" + str(STATS_NAME_WIDTH) + "s %8d %6d %6d %6d %6d %6d %6d %6d %6d %6d %6d %6d"):
        ...
        return tpl % (
            ...
            self.get_response_time_percentile(0.995),
...
def print_stats(stats):
    ...
    try:
        ...
        total_success = total_reqs
        fail_percent = (total_failures / float(total_success + total_failures)) * 100
    except ZeroDivisionError:
        fail_percent = 0
...
def get_percentile_stats_for_api(api_stat):
    percentile_stat = {}
    for percentile_str in PERCENTILES:
        percentile_stat[percentile_str] = api_stat.get_response_time_percentile(to_percent(percentile_str))
